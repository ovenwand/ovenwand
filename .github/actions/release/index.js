...
const readChangesetState = require('./lib/readChangesetState.js');
const { runPublish, runVersion } = require('./lib/run.js');
	...
	switch (true) {
		...
		case !hasChangesets && hasPublishScript: {
			...
			if (fs.existsSync(userNpmrcPath)) {
				...
				if (authLine) {
					console.log('Found existing auth token for the npm registry in the user .npmrc file');
				} else {
					console.log(
