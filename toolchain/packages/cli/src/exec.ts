import {
	spawn as _spawn,
	fork as _fork,
	type SpawnOptions as _SpawnOptions,
	type ForkOptions as _ForkOptions
...
export const fork = (command: string, args: string[] = [], options: ForkOptions = {}) =>
	createAsyncProcess('fork', command, args, options);
export const exec = (command: string, args: string[] = [], options: SpawnOptions = {}) =>
	createAsyncProcess('spawn', command, args, options);

function createAsyncProcess<T extends 'fork' | 'spawn'>(
	type: T,
	command: string,
	args = [],
	options: T extends 'fork' ? ForkOptions : SpawnOptions = {}
