...
export interface ObjectStore<
	State,
	Type extends GameObject<State> = GameObject<State>,
	Store extends GameObjectInstance<State> = GameObjectInstance<State>
> extends Readable<Store[]> {
	clear(): void;
...
export function createObjectStore<State, Type extends GameObject<State>>(
	objects: GameObjectInstance<State>[]
): ObjectStore<State, Type, GameObjectInstance<State>> {
