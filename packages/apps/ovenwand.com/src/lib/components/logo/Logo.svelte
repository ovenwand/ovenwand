...
<svg class={logoClassName} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 135.88 129.89">
	...
	<g id="Outline" data-name="Outline">
		<g id="Face">
			<path
				d="M68,69.89c17.09,0,31,11.67,31,26s-13.91,26-31,26-31-11.66-31-26,13.9-26,31-26m0-8c-21.54,0-39,15.22-39,34s17.46,34,39,34,39-15.22,39-34-17.46-34-39-34Z"
			/>
		</g>
		<path
			id="Crown"
